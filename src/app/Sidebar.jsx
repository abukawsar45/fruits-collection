...
const Sidebar = () => {
  return (
    <div className='mx-auto md:py-auto md:h-screen md:overflow-scroll lg:overflow-hidden top-0 flex justify-center  md:items-center border-amber-500 bottom-0 md:bottom-auto  '>
